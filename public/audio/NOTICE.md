...
"Space-Intercom-Emergency" by electrobadger, sourced from Freesound.org
(part of the pack "Space Intercom").

- Source: https://freesound.org/people/electrobadger/sounds/857486/
- Author: electrobadger
- License: Creative Commons 0 (CC0 1.0 Universal / public domain)
  https://creativecommons.org/publicdomain/zero/1.0/
- Original filename: `857486__electrobadger__space-intercom-emergency.wav`

CC0 means no attribution is legally required, but the author is credited
here anyway as a courtesy, consistent with the rest of this file.
